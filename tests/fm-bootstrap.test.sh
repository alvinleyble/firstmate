...
agy shared efforts are accepted^{"rules":[{"when":"agy low","use":{"harness":"agy","model":"gemini-3.1-pro","effort":"low"}},{"when":"agy medium","use":{"harness":"agy","effort":"medium"}},{"when":"agy high","use":{"harness":"agy","effort":"high"}}]}^empty^
unsupported agy xhigh effort is flagged^{"rules":[{"when":"agy deep work","use":{"harness":"agy","model":"gemini-3.1-pro","effort":"xhigh"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: agy:xhigh
unsupported agy max effort is flagged^{"rules":[{"when":"agy deep work","use":{"harness":"agy","model":"gemini-3.1-pro","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: agy:max
