...
FM_TEARDOWN_SKIP_SUPABASE=0  # 1 skips only the post-landing Supabase migration push and Edge Function deploy in fm-teardown.sh; the rest of the post-landing cleanup and staleness sweep still runs
