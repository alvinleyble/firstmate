...
| `fm-teardown.sh`         | Fail-closed teardown: return landed ship worktrees, require completed scout deliverables, retire secondmate homes, then run the ship task's post-landing project cleanup and staleness sweep |
